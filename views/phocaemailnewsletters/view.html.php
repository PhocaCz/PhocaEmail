...
class PhocaEmailCpViewPhocaEmailNewsletters extends JViewLegacy
{
	protected $items;
	...
	function addToolbar() {
		...
		if ($canDo->get('core.delete')) {
			JToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocaemailnewsletters.delete', $this->t['l'].'_DELETE');
		}
		JToolbarHelper::divider();
	...
	protected function getSortFields() {
		return array(
			...
			'a.subject' 	=> JText::_($this->t['l'] . '_SUBJECT'),
