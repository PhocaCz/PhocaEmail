...
class PhocaEmailCpModelPhocaEmailComprobar extends JModelAdmin
{
	protected	$option 		= 'com_phocaemail';
	protected 	$text_prefix	= 'com_phocaemail';
	public 		$typeAlias 		= 'com_phocaemail.phocaemailcomprobar';
	...
	public function getForm($data = array(), $loadData = true) {
		...
		$form 	= $this->loadForm('com_phocaemail.phocaemailcomprobar', 'phocaemailcomprobar', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) { 
			return false;
		}
		return $form;
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_phocaemail.edit.phocaemailcomprobar.data', array());
