...
class PhocaEmailRenderAdmin
{
	...
	public static function getLinks() {
		...
		switch ($option) {
			...
			case 'com_phocaemail':
				$links[]	= array('Phoca Email site', 'http://www.phoca.cz/phocaemail');
				$links[]	= array('Phoca Email documentation site', 'http://www.phoca.cz/documentation/category/60-phoca-email-component');
				$links[]	= array('Phoca Email download site', 'http://www.phoca.cz/download/category/47-phoca-email-component');
			break;
