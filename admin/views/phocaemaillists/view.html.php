...
class PhocaEmailCpViewPhocaEmailLists extends JViewLegacy
{
	protected $items;
	...
	function display($tpl = null) {
		...
		$this->t			= PhocaEmailUtils::setVars('list');
	...
	function addToolbar() {
		...
		JToolbarHelper::title( JText::_( $this->t['l'].'_MAILING_LISTS' ), 'list fa-list' );
		...
		if ($canDo->get('core.delete')) {
			JToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocaemaillists.delete', $this->t['l'].'_DELETE');
		}
		JToolbarHelper::divider();
