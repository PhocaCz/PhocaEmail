...
{
    protected $extension 	= 'com_phocaemail';
    protected $updatetext 	= 'COM_PHOCAEMAIL_UPDATE_TEXT';
    protected $installtext 	= 'COM_PHOCAEMAIL_INSTALL_TEXT';
    protected $versiontext	= 'COM_PHOCAEMAIL_VERSION';
    protected $extensiontext= 'COM_PHOCAEMAIL';
    protected $configuretext= 'COM_PHOCAEMAIL_CONFIGURE';
