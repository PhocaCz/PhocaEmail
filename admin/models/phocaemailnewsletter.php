...
class PhocaEmailCpModelPhocaEmailNewsletter extends AdminModel
{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_phocaemail.edit.phocaemailnewsletter.data', array());
