...
namespace Phoca\Component\Phocaemail\Administrator\View\Subscriber;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		$canDo		= SubscriberHelper::getActions($this->t, $this->state->get('filter.subscriber_id'));

		$text = $isNew ? Text::_( $this->t['l'] . '_NEW' ) : Text::_($this->t['l'] . '_EDIT');
		ToolbarHelper::title(   Text::_( $this->t['l'] . '_SUBSCRIBER' ).': <small><small>[ ' . $text.' ]</small></small>' , 'user fa-user');
