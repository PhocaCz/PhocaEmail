...
namespace Phoca\Component\phocaemail\Administrator\View\Newsletters;
...
class HtmlView extends BaseHtmlView
{
	...
	function addToolbar()
	{
		...
		$canDo	= NewslettersHelper::getActions($this->t, $state->get('filter.newsletter_id'));

		ToolbarHelper::title( Text::_( $this->t['l'].'_NEWSLETTERS' ), 'mail fa-paper-plane' );
		...
		if ($canDo->get('core.delete')) {
			ToolbarHelper::deleteList( $this->t['l'].'_WARNING_DELETE_ITEMS', 'phocaemailnewsletters.delete', $this->t['l'].'_DELETE');
		}
		ToolbarHelper::divider();
	...
	protected function getSortFields() {
		return array(
			...
			'a.subject' 	=> Text::_($this->t['l'] . '_SUBJECT'),
